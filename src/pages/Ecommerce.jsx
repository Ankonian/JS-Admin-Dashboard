...
const Ecommerce = () => {
  return (
    <div className="mt-12">
        ...
        <div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg h-44 rounded-xl w-full lg:w-full p-8 pt-9 m-3 bg-hero-pattern bg-no-repeat bg-cover bg-center">
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-2xl">$63.918.25</p>
            </div>
          </div>
          <div className="mt-6">
            <Button 
      ...
      <div className="flex gap-10 flex_wrap justify-center">
            <div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg m-3 p-4 rounded-1xl md:w-780">
